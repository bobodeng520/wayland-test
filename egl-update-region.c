...
static void redraw( int num)
{
	...
	eglQuerySurface(egl_display, egl_surface, EGL_BUFFER_AGE_EXT, &bufferAge);
	eglSetDamageRegionKHR(egl_display, egl_surface, egl_damage, nrects);
	...
	eglSwapBuffersWithDamageEXT(egl_display, egl_surface, egl_damage, nrects);
	free(egl_damage);
}
